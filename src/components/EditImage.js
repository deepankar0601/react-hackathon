...
function EditImage() {
  ...
  function handleFile() {
    document.getElementById('image_edit').click();
  }
  ...
  return (<section className="edit-image-section">
    ...
    <input type='file' id='image_edit' name='upload' accept="image/*" value={imageFile} onChange={handleImageUpload} hidden />
    <button style={{ border: 'none' }} type='submit' id='edit-submit' onClick={handleFile}><img src={mySvg.Imageicon} className='uploadImageEdit' required/>
